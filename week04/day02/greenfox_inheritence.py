class Person():
    def __init__(self, name = "Jane Doe", age = 30, gender = "female"):
        ...
        self.gender = gender
    def introduce(self):
        print("Hi, I am " + self.name + " a " + str(self.age) + " year old" + self.gender)
    def get_goal(self):
...
class Student(Person):
    ...
    def introduce(self):
        print("Hi, I'm " + self.name + ", a " + str(self.age) + " year old " + self.gender + " from " + self.previous_organization + "who skipped skipped_days days from the course already.")
